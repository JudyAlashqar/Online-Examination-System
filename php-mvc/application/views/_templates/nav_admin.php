...
<div class="nav-container" id="nav-container">
  <ul class="nav">
    ...
    <li class="role" id="Role">
      <a href=<?php echo URL."roles/index"; ?> >
          <span class="text">Roles</span>
      </a>
    </li>
    <li class="material" id="Material">
      <a href=<?php echo URL."materials/index";?> >
          <span class="text">Materials</span>
      </a>
    </li>
    <li class="topic" id="Topic" >
      <a href=<?php echo URL."topics/index"; ?>  >
          <span class="text">Topics</span>
      </a>
    </li>
    <li class="question" id="Question">
      <a href=<?php echo URL."questions/index"; ?> >
          <span class="text">Questions</span>
      </a>
    </li>
    <li class="test" id="Test">
      <a href=<?php echo URL."tests/index"; ?>  >
         <span class="text">Tests</span>
     </a>
   </li>
   <li class="test_center" id="Test_center">
      <a href=<?php echo URL."test_centers/index";?> >
         <span class="text">Test Centers</span>
     </a>
   </li>
  </ul>
</div>
