...
<head>
    ...
    <body>
        <div id="cover"> </div>
        <h1 id="welcome"> 
            Welcome to Test Center Online Exams Website
        </h1>  
        <div id="primary">
            <img src="http:\\127.0.0.1:8081\center_website\public\img\logo.png" alt="" id="icon">  
            <h2> Login </h2>
            <form method="post" action=<?php echo URL."home/loginCheck" ?> name="form1" onsubmit="return validate()" >
            <div class="input_field">
                <div id="ico"><img src="http:\\127.0.0.1:8081\center_website\public\img\email1.ico" height="22px" width="22px" ></div>
                <input  type="text" name="email" id="email" placeholder="Email" >
            </div>
            <div class="input_field">
                <div id="ico"><img src="http:\\127.0.0.1:8081\center_website\public\img\pass1.ico" height="20px" width="20px" ></div>
