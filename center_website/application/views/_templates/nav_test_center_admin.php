...
<div class="nav-container" id="nav-container">
  <ul class="nav">
    ...
    <li class="askForTest" id="askForTest" >
      <a href=<?php echo URL."test_center_admins/chooseMaterial"; ?>  >
        <span class="text">Ask for a Test</span>
      </a>
    </li>
    <li class="showStudentsResults" id="showStudentsResults">
      <a href=<?php echo URL."test_center_admins/showStudentsResults"; ?> >
          <span class="text">Students Results </span>
      </a>
    </li>
  </ul>
</div>
