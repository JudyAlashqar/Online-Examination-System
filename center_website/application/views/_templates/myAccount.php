...
<img id="imgg" src="http:\\127.0.0.1:8081\php-mvc\public\img\<?php echo $_SESSION['center_image']; ?>" /> <?php } ?>
<?php  if(isset($_SESSION['center_image'])) {?> <div id="info"> <?php }
else { ?>  <div>  <?php }
?>
...
<h2> phone number: <?php echo $_SESSION['center_phone'] ?> </h2> <?php } ?>
</div>
</div>